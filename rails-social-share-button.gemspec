...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{rails-social-share-button is one of the best rails helper gem​ to add social share feature in your Rails app. Such as Twitter, Facebook, Tumblr, Weibo, Douban, QQ...}
  spec.description   = %q{rails-social-share-button is one of the best rails helper gem​ to add social share feature in your Rails app. Such as Twitter, Facebook, Tumblr, Weibo, Douban, QQ...}
